...
const themeStyles: Record<RebuildResolvedThemeMode, React.CSSProperties> = {
  ...
  light: {
    ...
    ['--dashboard-page-bg' as string]: '#f8fafc',
    ['--dashboard-page-border' as string]: 'rgba(226,232,240,0)',
    ['--dashboard-sidebar-bg' as string]: '#f8fafc',
    ['--dashboard-sidebar-border' as string]: 'rgba(226,232,240,0)',
    ['--dashboard-card-bg' as string]: 'rgba(255,255,255,0.88)',
    ['--dashboard-card-border' as string]: 'rgba(226,232,240,0)',
    ['--dashboard-card-shadow' as string]: '0 14px 34px -30px rgba(15,23,42,0.18)',
    ['--dashboard-soft-bg' as string]: '#ffffff',
    ['--dashboard-soft-border' as string]: 'rgba(226,232,240,0)',
