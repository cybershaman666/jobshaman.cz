    ...
    <StepContainer step={step} stepIndex={stepIndex} totalSteps={totalSteps}>
      <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
        ...
        <div className="space-y-6">
          ...
          {/* Tips */}
          <div className="rounded-[12px] border border-amber-100 bg-amber-50/50 p-4">
        ...
        {/* Side context */}
        <div className="h-fit rounded-[12px] border border-slate-200 bg-slate-50 p-4 text-center">
          <div className="text-[11px] font-bold uppercase text-slate-400 tracking-wide">
            {t('rebuild.journey.word_count', { defaultValue: 'Word Count' })}
          </div>
          <div className="mt-2 text-3xl font-bold text-[#1f5fbf]">
