    ...
    <StepContainer step={step} stepIndex={stepIndex} totalSteps={totalSteps}>
      <div className="space-y-6">
        ...
        <div className="rounded-[12px] border border-blue-200 bg-blue-50 p-6">
          <div className="text-[11px] font-bold uppercase text-blue-700 tracking-wide">
        ...
        <div className="rounded-[12px] border border-slate-200 bg-slate-50 p-4">
          <div className="text-xs font-bold uppercase text-slate-600 tracking-wide mb-3">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="flex gap-3">
              ...
              <div>
                <div className="font-semibold text-slate-900">{t('rebuild.journey.clarity', { defaultValue: 'Clarity' })}</div>
                <div className="text-xs text-slate-600">{t('rebuild.journey.clarity_desc', { defaultValue: 'Clear thinking' })}</div>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="flex-shrink-0 text-lg">🔍</span>
              <div>
                <div className="font-semibold text-slate-900">{t('rebuild.journey.insight', { defaultValue: 'Insight' })}</div>
                <div className="text-xs text-slate-600">{t('rebuild.journey.insight_desc', { defaultValue: 'Deep understanding' })}</div>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="flex-shrink-0 text-lg">⚙️</span>
              <div>
                <div className="font-semibold text-slate-900">{t('rebuild.journey.practicality', { defaultValue: 'Practicality' })}</div>
                <div className="text-xs text-slate-600">{t('rebuild.journey.practicality_desc', { defaultValue: 'Doable solutions' })}</div>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="flex-shrink-0 text-lg">🛠️</span>
              <div>
                <div className="font-semibold text-slate-900">{t('rebuild.journey.execution', { defaultValue: 'Execution' })}</div>
                <div className="text-xs text-slate-600">{t('rebuild.journey.execution_desc', { defaultValue: 'Next steps' })}</div>
              </div>
            </div>
          </div>
        </div>
