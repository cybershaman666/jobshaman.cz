...
export const mapCompanyProfileToCompany = (companyProfile: CompanyProfile): Company => {
  ...
  return {
    ...
    website: companyProfile.website || companyProfile.website_url || '',
    websiteUrl: companyProfile.website_url || companyProfile.website || '',
    brandColor: companyProfile.brand_color || '',
    ...
    theme: {
      ...
      ...(companyProfile.brand_color ? { primary: companyProfile.brand_color } : {}),
