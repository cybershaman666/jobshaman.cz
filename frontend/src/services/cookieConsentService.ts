...
export class CookieConsentManager {
  ...
  getCategoryExplanation(category: keyof CookiePreferences): {
    ...
    const explanations = {
      necessary: {
        title: 'rebuild.ui.cookie_banner.cat_necessary_title',
        description: 'rebuild.ui.cookie_banner.cat_necessary_desc',
        examples: ['Přihlášení', 'Session management', 'Ochrana proti CSRF'],
        required: true
      },
      analytics: {
        title: 'rebuild.ui.cookie_banner.cat_analytics_title',
        description: 'rebuild.ui.cookie_banner.cat_analytics_desc',
        examples: ['Google Analytics', 'Hotjar', 'Microsoft Clarity'],
        required: false
      },
      marketing: {
        title: 'rebuild.ui.cookie_banner.cat_marketing_title',
        description: 'rebuild.ui.cookie_banner.cat_marketing_desc',
        examples: ['Facebook Pixel', 'Google Ads', 'LinkedIn Insight Tag'],
        required: false
      },
      functional: {
        title: 'rebuild.ui.cookie_banner.cat_functional_title',
        description: 'rebuild.ui.cookie_banner.cat_functional_desc',
        examples: ['Live chat', 'Sociální sítě', 'Připomenutí na akce'],
        required: false
      },
      preferences: {
        title: 'rebuild.ui.cookie_banner.cat_preferences_title',
        description: 'rebuild.ui.cookie_banner.cat_preferences_desc',
