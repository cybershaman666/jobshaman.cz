...
export const resolveJobDomain = (job: Job): CandidateDomainKey | null => {
  ...
  if (hasAny(/\bv[ýy]rob\w*/i, /\bd[ěe]ln[ií]k\w*/i, /\bmistr\b/i, /\bmanufacturing\b/i, /\bmont[aá]ž\w*/i, /\boperator v[ýy]rob\w*/i, /\bcnc\b/i, /\bobrab\w*/i, /\bmachin\w*/i, /\bsoustruh\w*/i, /\bfr[eé]z\w*/i)) return 'manufacturing';
  ...
  if (hasAny(/\bin[žz]en[ýy]r\w*/i, /\bengineering\b/i, /\bmechanik\b/i, /\btechnik\b/i, /\bcnc\b/i, /\bobrab\w*/i, /\bmachin\w*/i, /\bsoustruh\w*/i, /\bfr[eé]z\w*/i, /\bautomation\b/i, /\belectrical\b/i, /\bmaintenance\b/i)) return 'engineering';
