...
const LegalPage = ({ title, children, icon: Icon, backLink = "/", backLabel = "Back to app", widthClassName = "max-w-4xl" }: {
  title: string; 
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
        <div className={`${widthClassName} mx-auto px-4 py-6`}>
      ...
      {/* Content */}
      <div className={`${widthClassName} mx-auto px-4 py-12`}>
