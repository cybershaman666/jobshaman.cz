...
const CompanyOnboarding: React.FC<CompanyOnboardingProps> = ({ userId, onComplete, onCancel }) => {
    ...
    const renderStep1 = () => (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-4">
                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 font-mono">Fakturační & Právní Údaje</h3>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:col-span-2 relative">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">Název Firmy</label>
                    ...
                    <div className="relative">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">IČO</label>
                        <input
                    ...
                    <div className="relative">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">DIČ (VAT)</label>
                        <input
                            className="w-full p-3.5 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white placeholder:text-slate-500 focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 outline-none transition-all"
                    ...
                    <div className="sm:col-span-2 relative">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">Sídlo (Adresa)</label>
                        <div className="relative group">
            ...
            <div className="bg-cyan-50/50 dark:bg-cyan-500/5 border border-cyan-100 dark:border-cyan-500/10 p-4 rounded-xl flex items-start gap-3">
                ...
                <p className="text-xs text-cyan-800 dark:text-cyan-200 leading-relaxed">
                    Tyto údaje slouží pro ověření vaší společnosti. Inzeráty od ověřených firem mají vyšší prioritu a dosah.
                </p>
            </div>
    ...
    const renderStep2 = () => (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-4">
                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 font-mono">Profil & Kultura</h3>

                <div className="space-y-4">
                    <div className="relative group">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">Odvětví</label>
                        <div className="relative">
                    ...
                    <div className="relative group">
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">Filosofie & Mise</label>
                        <div className="relative">
                            ...
                            <textarea
                                ...
                                placeholder="Naše mise je propojovat talenty se smysluplnou prací..."
                ...
                <div className="p-8 sm:p-10">
                    ...
                    <div className="mb-10">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Registrace Společnosti</h2>
                        </div>
