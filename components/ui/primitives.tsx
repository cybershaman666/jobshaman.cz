...
export const SurfaceCard: React.FC<{
  ...
  <div
    className={cn(
      ...
      tone === 'accent' && 'bg-[linear-gradient(180deg,rgba(255,249,235,0.98),rgba(255,243,224,0.94))] border-amber-200/70 dark:bg-[linear-gradient(180deg,rgba(255,249,235,0.98),rgba(255,243,224,0.94))] dark:border-amber-200/70 dark:[--text-strong:#172033] dark:[--text:#223249] dark:[--text-muted:#5f6f84] dark:[--text-faint:#7d8aa0]',
      className
    )}
  >
    {children}
...
export const MetricTile: React.FC<{
  ...
  <div
    className={cn(
      ...
      tone === 'accent' && 'bg-[rgba(255,248,233,0.96)] border-amber-200/80 dark:bg-[rgba(255,248,233,0.96)] dark:border-amber-200/80 dark:[--text-strong:#172033] dark:[--text:#223249] dark:[--text-muted:#5f6f84] dark:[--text-faint:#7d8aa0]',
