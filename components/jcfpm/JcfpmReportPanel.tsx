              ...
              <div className="space-y-5 flex-1 p-2">
                {alignmentBars.map((bar) => (
                  <div key={bar.label} className="relative">
                    ...
                    <div className="relative h-2 rounded-full border border-slate-200 dark:border-slate-800 bg-gradient-to-r from-rose-50 via-slate-100 to-amber-50 dark:from-rose-500/5 dark:via-slate-800 dark:to-amber-500/5 print:from-slate-100 print:to-slate-100">
