...
const CompanyQuickStartPanel: React.FC<CompanyQuickStartPanelProps> = ({
  ...
  return (
    <div className="company-surface-elevated overflow-hidden rounded-[26px] border border-slate-200/80 bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.12),_transparent_26%),linear-gradient(180deg,_rgba(255,255,255,0.98),_rgba(248,250,252,0.95))] p-5 shadow-[0_24px_48px_-36px_rgba(15,23,42,0.42)] dark:border-slate-800 dark:bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.14),_transparent_24%),linear-gradient(180deg,_rgba(15,23,42,0.98),_rgba(2,6,23,0.94))]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
        <button onClick={onOpenJobs} className="company-surface-subtle text-left rounded-[22px] border border-slate-200/80 bg-white/85 p-4 shadow-[0_14px_30px_-28px_rgba(15,23,42,0.35)] transition-colors hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950/30 dark:hover:bg-slate-950/50">
        ...
        <button onClick={onOpenAssessments} className="company-surface-subtle text-left rounded-[22px] border border-slate-200/80 bg-white/85 p-4 shadow-[0_14px_30px_-28px_rgba(15,23,42,0.35)] transition-colors hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950/30 dark:hover:bg-slate-950/50">
          <div className="flex items-center gap-2 text-sm font-semibold text-slate-900 dark:text-white">
        ...
        <button onClick={onOpenSettings} className="company-surface-subtle text-left rounded-[22px] border border-slate-200/80 bg-white/85 p-4 shadow-[0_14px_30px_-28px_rgba(15,23,42,0.35)] transition-colors hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950/30 dark:hover:bg-slate-950/50">
          <div className="flex items-center gap-2 text-sm font-semibold text-slate-900 dark:text-white">
            <Users size={14} />
