...
const OverviewQueueItem: React.FC<OverviewQueueItemProps> = ({ item }) => {
  ...
  return (
    <button onClick={item.action} className="company-surface-subtle app-organic-panel-soft w-full rounded-[var(--radius-md)] border p-4 text-left shadow-[var(--shadow-soft)] transition-colors hover:border-[rgba(var(--accent-rgb),0.22)] hover:bg-[var(--surface-elevated)]">
