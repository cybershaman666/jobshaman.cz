...
-- Supports: location/city, distance radius, contract type, benefits, salary, date, experience, pagination
            ...
            OR (
                ...
                (
                    ...
                    AND (
                        ...
                        OR 'IČO' = ANY(j.tags)
                        OR 'Kontraktor' = ANY(j.tags)
                        OR 'Freelance' = ANY(j.tags)
                        OR 'Gig Economy' = ANY(j.tags)
                    )
                )
                ...
                (
                    ...
                    AND (
                        ...
                        OR 'Part-time' = ANY(j.tags)
                        OR 'Zkrácený' = ANY(j.tags)
                        OR 'Brigáda' = ANY(j.tags)
                    )
                )
        ...
        AND (
            ...
            OR (
                ...
                WHERE EXISTS (
                    ...
                    OR required_benefit = ANY(j.tags)
            )
