...
export const buildCompanyHandshakeDecisionView = (
  ...
  const normalizedBrief = (safeRecord(applicationPayload.practical_assessment_brief) || null) as JobSignalBoostBrief | null;
  const fallbackBrief = (safeRecord(applicationPayload.signal_boost_brief) || null) as JobSignalBoostBrief | null;
