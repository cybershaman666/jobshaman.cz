                ...
                description = build_description(
                    detail_soup,
                    {
                        'paragraphs': [
                            ...
                            '[data-test="section-requirements"] p',
                            '[data-test="section-offered"] p',
                            '[data-test="block-description"] p',
                            '[data-test="section-description"] p',
                        ],
                        'lists': [
                            '[data-test="section-responsibilities"] ul',
                            '[data-test="section-requirements"] ul',
                            '[data-test="section-offered"] ul',
                            '[data-test="block-description"] ul',
