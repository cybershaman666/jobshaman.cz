...
from app.core.legacy_compat import (
    get_current_user, verify_csrf_token_header,
    supabase, now_iso
)
...
from app.services.job_signal_boost_store import get_signal_boost_analytics_summary
...
async def admin_ai_quality_evaluate(
    ...
    require_admin_user(user)
    # V2 recommendation evaluation is handled by the ai_governance domain.
