...
STRIPE_PRICE_BASIC = os.getenv("STRIPE_PRICE_BASIC", "price_1T3HoNG2Aezsy59e9FrKNi1W")
STRIPE_PRICE_PROFESSIONAL = os.getenv("STRIPE_PRICE_PROFESSIONAL", "price_1T3HrBG2Aezsy59eD80tf7nQ")
